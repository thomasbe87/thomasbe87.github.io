...
window.addEventListener("load", () => {
  // Ajout de la classe gsap-animated aux éléments animés
  document.querySelectorAll("h1, .img-move, blockquote").forEach(el => {
...
function d3_geo_greatArcInterpolator() {
  ...
  document.getElementById('backtotop-button').addEventListener('click', function(e) {
    e.preventDefault();
    window.scrollTo({
      top: 0,
      behavior: 'smooth'
